...
uint8_t write_cont[1024] MEM_ALIGNED(8) = "111111111111111";
...
{	
	uint32_t ramsource;
	ramsource = (uint32_t)&write_cont[0];
	interflash_ret2 = flash_write_bytes((uint8_t *)ramsource, 0x8003000, sizeof(write_cont));
